    ...
    , m_model(new QStandardItemModel(this))
{
    ...
    connect(checkBox, &QCheckBox::checkStateChanged, m_filter, [this](Qt::CheckState state) {
        m_filter->setIncludeCheckedOnly(state == Qt::Checked);
    });
...
void SubscriptionDialog::readConfig()
{
    ...
    KConfigGroup group(KSharedConfig::openStateConfig(), QStringLiteral("SubscriptionDialog"));
...
void SubscriptionDialog::onReloadRequested()
{
    ...
    if (m_capabilities.contains(QLatin1String("LIST-EXTENDED"))) {
        ...
        list->setReturnOptions(KIMAP::ListReturnOptions::Subscribed{});
    }
