    ...
    m_resource( parent )
{
    ...
    m_reloadCalendarsBtn = new KPushButton( KIcon( "view-refresh" ), i18n( "Reload" ), m_calendarsBox );
    ...
    m_reloadTaskListsBtn = new KPushButton( KIcon( "view-refresh" ), i18n( "Reload" ), m_taskListsBox );
