 ...
 * Command line was: dbusxml2cpp -m -a resourceadaptor -i resourcebase.h -l PIM::Resource /usr/src/kde4/kdepim/akonadi/resources/include/org.kde.Akonadi.Resource.xml
 *
...
"  </interface>\n"
        "")
public:
    ResourceAdaptor(PIM::Resource *parent);
    virtual ~ResourceAdaptor();

    inline PIM::Resource *parent() const
    { return static_cast<PIM::Resource *>(QObject::parent()); }
