...
void UrlConfigurationDialog::readConfig()
{
    ...
    KConfigGroup group(KSharedConfig::openStateConfig(), QStringLiteral("UrlConfigurationDialog"));
...
{
    KConfigGroup grp(KSharedConfig::openStateConfig(), QStringLiteral("UrlConfigurationDialog"));
