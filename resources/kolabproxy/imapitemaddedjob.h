...
class ImapItemAddedJob: public KJob
{
    Q_OBJECT
public:
    ImapItemAddedJob(const Akonadi::Item &imapItem, const Akonadi::Collection &imapCollection, const KolabHandler::Ptr &handler, QObject* parent);
    virtual void start();
private slots:
...
private:
    ...
    const KolabHandler::Ptr mHandler;
