...
#ifndef AKONADI_MAPPEDVCARDSTORE_H
#define AKONADI_MAPPEDVCARDSTORE_H
...
/**
 */
class AKONADI_FILESTORE_EXPORT MappedVCardStore : public AbstractDirectAccessStore
{
  Q_OBJECT

  public:
    explicit MappedVCardStore( QObject *parent = 0 );

    virtual ~MappedVCardStore();
