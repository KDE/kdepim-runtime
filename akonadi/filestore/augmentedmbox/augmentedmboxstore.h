...
#ifndef AKONADI_AUGMENTEDMBOXSTORE_H
#define AKONADI_AUGMENTEDMBOXSTORE_H
...
/**
 */
class AKONADI_FILESTORE_EXPORT AugmentedMBoxStore : public AbstractDirectAccessStore
{
  Q_OBJECT

  public:
    explicit AugmentedMBoxStore( QObject *parent = 0 );

    virtual ~AugmentedMBoxStore();
