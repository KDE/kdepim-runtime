...
// MOC_SKIP_END
  ...
  public:
    ...
    explicit QwtAbstractSlider( Qt::Orientation, QWidget *parent = 0 );
  ...
  signals:
    ...
    */
    ...
    /*!
      This signal is emitted every time the value changes.
      \param delta the difference of the old and the new value
    */
    void valueDelta( double delta );
